from tkinter import Tk,Label,Button,filedialog,SE,SW,S,NSEW,Scrollbar,VERTICAL,Text,END,DISABLED
import re
import os
...
def browseFiles():
    ...
    global filE 
    filE=''
    filename = filedialog.askopenfilename(initialdir = "shell:MyComputerFolder", 
                                          title = "Select a File", 
    ...
    if os.path.isdir(f"D:/apktool/{filE.replace('.apk','')}") == False:
        os.system('cmd /c "copy \"'+filename.replace("/","\\")+'\" D:\\apktool"') 
...
def apktool():
    ...
    signature =["android.permission.MOUNT_UNMOUNT_FILESYSTEMS","android.permission.BATTERY_STATS","android.permission.BIND_ACCESSIBILITY_SERVICE","android.permission.BIND_AUTOFILL_SERVICE","android.permission.BIND_CALL_REDIRECTION_SERVICE","android.permission.BIND_CARRIER_MESSAGING_CLIENT_SERVICE","android.permission.BIND_CARRIER_SERVICES","android.permission.BIND_CHOOSER_TARGET_SERVICE","android.permission.BIND_CONDITION_PROVIDER_SERVICE","android.permission.BIND_DEVICE_ADMIN","android.permission.BIND_DREAM_SERVICE","android.permission.BIND_INCALL_SERVICE","android.permission.BIND_INPUT_METHOD","android.permission.BIND_MIDI_DEVICE_SERVICE","android.permission.BIND_NFC_SERVICE","android.permission.BIND_NOTIFICATION_LISTENER_SERVICE","android.permission.BIND_PRINT_SERVICE","android.permission.BIND_QUICK_ACCESS_WALLET_SERVICE","android.permission.BIND_REMOTEVIEWS","android.permission.BIND_SCREENING_SERVICE","android.permission.BIND_TELECOM_CONNECTION_SERVICE","android.permission.BIND_TEXT_SERVICE","android.permission.BIND_TV_INPUT","android.permission.BIND_VISUAL_VOICEMAIL_SERVICE","android.permission.BIND_VOICE_INTERACTION","android.permission.BIND_VPN_SERVICE","android.permission.BIND_VR_LISTENER_SERVICE","android.permission.BIND_WALLPAPER","android.permission.CHANGE_CONFIGURATION","android.permission.CLEAR_APP_CACHE","android.permission.DELETE_CACHE_FILES","android.permission.GET_ACCOUNTS_PRIVILEGED","android.permission.GLOBAL_SEARCH","android.permission.INSTANT_APP_FOREGROUND_SERVICE","android.permission.LOADER_USAGE_STATS","android.permission.MANAGE_EXTERNAL_STORAGE","android.permission.PACKAGE_USAGE_STATS","com.android.voicemail.permission.READ_VOICEMAIL","android.permission.REQUEST_INSTALL_PACKAGES","android.permission.SMS_FINANCIAL_TRANSACTIONS","android.permission.START_VIEW_PERMISSION_USAGE","android.permission.SYSTEM_ALERT_WINDOW","android.permission.WRITE_SETTINGS","com.android.voicemail.permission.WRITE_VOICEMAIL"]
    
    global filE
    if os.path.isdir(f"D:/apktool/{filE.replace('.apk','')}") == False:
        os.system(f'cmd /c "cd /d D:\\apktool & apktool.jar d {filE} & del {filE}"')
    f = open(f"D:\\apktool\\{filE.replace('.apk','')}\\AndroidManifest.xml","r")
